...
## 2. Documentation (PEP 257 Mandatory, and relevant parts of PEP 8)
...
2. **Mandatory**:
    ...
    - Class initialization is included in the class' docstring. If required, a docstring for the class constructor (__init__) can, optionally, be added to provide detailed initialization documentation.
...
3. **Markup Syntax Rules (reST)**:
    ...
    - **Enphasis**: Use *italics*, **bold** if needed in any explanations.
